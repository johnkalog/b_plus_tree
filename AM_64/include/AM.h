...
#define AME_OK 0
#define AME_EOF -1
#define AME_INVALID_FILENAME -2
#define AME_NO_FREE_SPACE_FOR_OPEN_FILE -3
#define AME_CAN_NOT_CLOSE_BECAUSE_OPEN_SCAN -4
#define AME_MAXSCANS_ARRAY_FULL -5
#define AME_NONE_ENTRY_FOR_SCAN -6
#define AME_TRIED_TO_CLOSE_NONEXISTENT_SCAN -7
#define AME_INVALID_SCANDESC -8
